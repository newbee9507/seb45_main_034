...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.headers().frameOptions().sameOrigin()
                ...
                .and() // 아래의 CorsConfigurationSource를 필터에 적용
...
//                                new OAuth2SuccessHandler(jwtTokenizer, authorityUtils, userService)));
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "http://localhost:8080", "http://miniflix.s3-website.ap-northeast-2.amazonaws.com/", "http://miniflix.s3-website.ap-northeast-2.amazonaws.com"));
